...
const contributions_controller_1 = require("./controllers/contributions.controller");
...
exports.ContributionsModule = ContributionsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([contribution_entity_1.Contribution, gift_event_entity_1.GiftEvent]),
        ],
